                ...
                <div className="flex flex-col justify-center items-center gap-6 lg:gap-8">
                    ...
                    {leaders.length > 0 && (
                        <div className="flex justify-center">
                            ...
                            >
                                {/* Card Container */}
                                <div className="relative w-[296px] h-[394px] overflow-hidden rounded-3xl bg-white/80 backdrop-blur-md border border-blue-200 transition-all duration-500 hover:border-blue-600/50 hover:bg-white/90 shadow-sm hover:shadow-md">
                                    {/* Image Section */}
                                    ...
                                    <div className="absolute inset-x-0 bottom-0 p-6 space-y-3">
                                        {/* Title - Name */}
                                        <p className="text-lg text-white tracking-wide uppercase">{leaders[0].name}</p>
                    ...
                    {/* Rest of Leaders */}
                    <div className="flex flex-wrap lg:grid-cols-3 gap-6 lg:gap-8 justify-center">
